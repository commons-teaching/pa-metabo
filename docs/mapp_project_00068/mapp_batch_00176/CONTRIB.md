...
paths:
  ...
  input_folder: /home/allardpm/git_repos/commons-teaching/pa-metabo/docs/mapp_project_00068/mapp_batch_00176/results/met_annot_enhancer # The path were you want your GNPS job folder to be placed
  ...
  output_folder: /home/allardpm/git_repos/commons-teaching/pa-metabo/docs/mapp_project_00068/mapp_batch_00176/results/met_annot_enhancer # the path for your output to be stored in
...
```
```bash
python /home/allardpm/git_repos/commons-teaching/mandelbrot_project/met_annot_enhancer/src/dev/nb.py
```
...
```yaml
paths:
  docs: '/home/allardpm/git_repos/commons-teaching/pa-metabo/docs'
  output: '/home/allardpm/git_repos/commons-teaching/pa-metabo/docs/mapp_project_00068/mapp_batch_00176/results/stats' # Not mandatory, default is in the stats subdirectory
...
``````bash
Rscript /home/allardpm/git_repos/commons-teaching/biostat_toolbox/src/biostat_toolbox.r
```
